...
export const metadata: Metadata = {
  title: "JIDOKA · Auditoría Inteligente de Facturación de Siniestros",
  description:
    "Auditoría automática de facturas de talleres contra el tarifario pactado y la siniestralidad reportada: reglas deterministas, agente de IA explicativo y decisión humana solo en las excepciones.",
  keywords: ["auditoría", "siniestros", "agente IA", "tarifario", "aseguradora", "Panamá"],
  icons: {
